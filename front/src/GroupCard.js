...
class GroupCard extends Component {
  ...
  render() {    
    const { group, editExpiry, removeMemberFromGroup, getGroupUserChangeHistory } = { ...this.props }
      ...
      <Card id={`${group.dn}-card`}>
        ...
        <Accordion.Collapse eventKey={group.dn}>
          <Card.Body>
            ...
            <GroupTableBlock editExpiry={editExpiry} getGroupUserChangeHistory={getGroupUserChangeHistory} removeMemberFromGroup={removeMemberFromGroup} group={group}/>
          </Card.Body>
        </Accordion.Collapse>
      </Card>
    )
